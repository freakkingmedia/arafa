...
const templates = {
  ...
  template5: {
    ...
    image: "/assets/templates/template-5.bmp?v=20260614-peringode-v5",
    password: "p24",
    options: { bloodGroup: true },
    ...
    fields: {
      ...
      bloodGroup: { x: 414, y: 796, w: 160, size: pt(7.6), minSize: pt(6.2), weight: 500, color: "#000000", prefix: "Blood : " },
