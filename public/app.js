...
const templates = {
  ...
  template5: {
    ...
    image: "/assets/templates/template-5.bmp?v=20260615-peringode-class-adm",
    password: "p24",
    options: { bloodGroup: true },
    ...
    fields: {
      ...
      admissionNo: { x: 374, y: 728, w: 194, size: pt(7.8), minSize: pt(6.2), weight: 500, color: "#000000", prefix: "Adm. No : " },
